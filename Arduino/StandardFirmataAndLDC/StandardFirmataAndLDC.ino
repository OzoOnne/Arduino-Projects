...
// Initialize the LiquidCrystal_I2C library with the I2C address and the number of columns and rows of the LCD
LiquidCrystal_I2C lcd(0x27, 16, 2);

// Define the SysEx commands for LCD interaction
#define LCD_PRINT 0x01
#define LCD_CLEAR 0x02
#define LCD_SET_CURSOR 0x0
